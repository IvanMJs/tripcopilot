-- Fix: save_draft_trip was passing text to date columns without explicit cast.
-- iso_date, check_in_date, and check_out_date are type DATE but ->> extracts TEXT.
-- PostgreSQL 14+ does NOT implicitly coerce text -> date in function SECURITY DEFINER context.
