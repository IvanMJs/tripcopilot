...
<head>
  ...
  <title>Resumen de vuelo — ${esc(flight.flightCode)}</title>
  <style>
...
<body>
  <div class="ticket">
    <div class="ticket-header">
      ...
      <div class="bp-label">Resumen<br/>de vuelo</div>
    </div>
    ...
    <div class="notice">
      ⚠️ Este documento es un resumen informativo generado por TripCopilot. No es un boarding pass válido. Usá el boarding pass oficial emitido por tu aerolínea.
    </div>
  </div>
</body>
</html>`;
