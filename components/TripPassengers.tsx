        ...
        {!readOnly && (
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 rounded-lg bg-[#FFB800] px-3 py-1.5 text-xs font-medium text-[#07070d] hover:bg-[#FFC933] transition-colors"
            >
        ...
        >
          ...
          <div className="flex gap-2 pt-1">
            <button
              type="submit"
              disabled={submitting}
              className="flex items-center gap-1.5 rounded-lg bg-[#FFB800] px-4 py-2 text-sm font-medium text-[#07070d] hover:bg-[#FFC933] disabled:opacity-50 transition-colors"
            >
              {submitting ? (
              ...
              >
                ...
                <div className="mt-0.5 flex items-center gap-1 shrink-0">
                  <button
                    ...
                    className="rounded-lg p-1.5 text-slate-500 hover:bg-[#FFC933]/10 hover:text-blue-400 transition-colors"
