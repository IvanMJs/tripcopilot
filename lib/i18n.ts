...
export const translations = {
  es: {
    ...
    // Airport card
    noDelaysReported: "Sin problemas",
    delay: "Demoras",
    cause: "Por",
    affects: "En",
    departures: "los vuelos que salen",
    arrivals: "los vuelos que llegan",
    groundStop: "Vuelos pausados",
    until: "hasta",
    indefinite: "tiempo indefinido",
    groundDelayProgram: "Programa de demoras",
    average: "Promedio",
    max: "Máx",
  ...
  en: {
    ...
    // Airport card
    noDelaysReported: "No issues",
    delay: "Delays",
    cause: "Due to",
    affects: "Affecting",
    departures: "departing flights",
    arrivals: "arriving flights",
    groundStop: "Flights paused",
    until: "until",
    indefinite: "indefinite",
    groundDelayProgram: "Delay program active",
    average: "Average",
    max: "Max",
